  ...
  <main id="main">
    ...
    <section class="section c01-workflow" id="workflow" aria-labelledby="workflow-title">
      <div class="shell">
        ...
        <figure class="product-screenshot product-screenshot-dark">
          <a class="product-screenshot-frame" href="../assets/screenshots/filepreflight-windows-explorer-right-click.png" aria-label="Open the full-size Windows Explorer screenshot">
            <img src="../assets/screenshots/filepreflight-windows-explorer-right-click.png" width="1920" height="1080" loading="lazy" decoding="async" alt="Windows 11 File Explorer showing the FilePreflight Create Safe Copy command in a file's right-click menu" />
          </a>
          <figcaption><strong>Start from File Explorer.</strong> Current Windows development build shown. Right-click a supported file and choose <span>FilePreflight — Create Safe Copy</span>. <a href="../assets/screenshots/filepreflight-windows-explorer-right-click.png">View full size</a>.</figcaption>
        </figure>
    ...
    <section class="section c01-evidence" id="evidence" aria-labelledby="evidence-title">
      <div class="shell c01-evidence-layout">
        ...
        <div class="c01-evidence-grid">
          ...
          <article><span class="c01-evidence-number">02</span><h3>Synthetic redaction demo</h3><p>Educational PDFs compare visual covering with a separately authored file in which the test values are absent. They are explicitly not FilePreflight output.</p><a href="../downloads/pdf-redaction-demo/">Open the demo →</a></article>
